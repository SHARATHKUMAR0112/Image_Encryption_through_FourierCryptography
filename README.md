...
Quick links:
- **[Getting Started](docs/PROJECT_OVERVIEW.md)** - Installation, quick start, and basic usage
- **[Architecture Guide](docs/ARCHITECTURE.md)** - System design and component structure
- **[API Documentation](docs/API_GUIDE.md)** - REST API endpoints and examples
- **[Security Guide](docs/SECURITY.md)** - Security implementation and best practices
- **[Visualization Guide](docs/VISUALIZATION_GUIDE.md)** - How to see the live epicycle animation
- **[Plugin Development](docs/PLUGIN_GUIDE.md)** - Creating custom plugins
